import{_ as p}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as k,c as d,a as c,w as a,b as n,d as s,e as u,r as i}from"./app.59f8625c.js";const m={},v=u('<h1 id="_3-errors包" tabindex="-1"><a class="header-anchor" href="#_3-errors包" aria-hidden="true">#</a> 3. errors包</h1><h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h2><p><code>errors</code> 包提供了一个 <code>error</code> 接口的实现，它可以用来包装其他 <code>error</code>，并且可以通过 <code>errors.Is</code> 和 <code>errors.As</code> 来判断是否是某个特定的 <code>error</code>。</p><h2 id="用法" tabindex="-1"><a class="header-anchor" href="#用法" aria-hidden="true">#</a> 用法</h2>',4),b=n("ul",null,[n("li",null,[n("code",null,"New"),s(" 方法返回一个由所给的 "),n("code",null,"text"),s(" 格式化的错误类型。每一个 "),n("code",null,"New"),s(" 方法返回的错误都是不同的即使 "),n("code",null,"text"),s(" 一致")])],-1),g=n("div",{class:"language-go line-numbers-mode","data-ext":"go"},[n("pre",{class:"language-go"},[n("code",null,[n("span",{class:"token keyword"},"package"),s(` main
