import{_ as p}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as r,c as k,b as n,d as s,a as o,w as a,e as d,r as u}from"./app.9d267368.js";const m={},b=n("h1",{id:"_4-viper包",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_4-viper包","aria-hidden":"true"},"#"),s(" 4. viper包")],-1),v=n("h2",{id:"介绍",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#介绍","aria-hidden":"true"},"#"),s(" 介绍")],-1),g={href:"https://github.com/spf13/viper",target:"_blank",rel:"noopener noreferrer"},f=d('<p><code>viper</code> 包提供了一个配置文件的读取和解析的库，它可以读取多种格式的配置文件，比如 <code>json</code>、<code>yaml</code>、<code>toml</code> 等，并且可以通过 <code>viper</code> 的 <code>Set</code> 方法来设置配置项。</p><h2 id="用法" tabindex="-1"><a class="header-anchor" href="#用法" aria-hidden="true">#</a> 用法</h2>',2),h=n("ul",null,[n("li",null,"config.yml")],-1),y=n("div",{class:"language-yaml line-numbers-mode","data-ext":"yml"},[n("pre",{class:"language-yaml"},[n("code",null,[n("span",{class:"token key atrule"},"name"),n("span",{class:"token punctuation"},":"),s(),n("span",{class:"token number"},"123"),s(`
