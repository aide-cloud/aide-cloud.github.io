import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,e}from"./app.edb15a4e.js";const i={},t=e(`<h1 id="_6-channel" tabindex="-1"><a class="header-anchor" href="#_6-channel" aria-hidden="true">#</a> 6. channel</h1><blockquote><p>通道（channel）是用来传递数据的一个数据结构</p></blockquote><h2 id="语法" tabindex="-1"><a class="header-anchor" href="#语法" aria-hidden="true">#</a> 语法</h2><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code># 声明
