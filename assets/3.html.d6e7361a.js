import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,e}from"./app.dbe18ecb.js";const i={},l=e(`<h1 id="dockerfile" tabindex="-1"><a class="header-anchor" href="#dockerfile" aria-hidden="true">#</a> Dockerfile</h1><h2 id="第一个dockerfile" tabindex="-1"><a class="header-anchor" href="#第一个dockerfile" aria-hidden="true">#</a> 第一个Dockerfile</h2><ul><li>Dockerfile是一个文本文件，用于定义一个镜像的构建过程</li></ul><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code><span class="token instruction"><span class="token keyword">FROM</span> alpine:3.12</span>
