import{_ as i}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as l,c as t,b as n,d as a,a as e,e as o,r as c}from"./app.fb4e36e5.js";const p={},r=o(`<h1 id="_5-部署一个go项目" tabindex="-1"><a class="header-anchor" href="#_5-部署一个go项目" aria-hidden="true">#</a> 5. 部署一个go项目</h1><h2 id="准备一个go项目" tabindex="-1"><a class="header-anchor" href="#准备一个go项目" aria-hidden="true">#</a> 准备一个go项目</h2><ul><li>创建一个<code>go</code>项目</li></ul><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token comment">// main.go</span>
...
├── docker-compose.yml
└── main.go
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="部署" tabindex="-1"><a class="header-anchor" href="#部署" aria-hidden="true">#</a> 部署</h2><ul><li>启动服务</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker-compose</span> up <span class="token parameter variable">-d</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li>查看服务</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker-compose</span> <span class="token function">ps</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li>查看日志</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker-compose</span> logs <span class="token parameter variable">-f</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul><li>停止服务</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker-compose</span> down
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="参考" tabindex="-1"><a class="header-anchor" href="#参考" aria-hidden="true">#</a> 参考</h2>`,25),d={href:"https://docs.docker.com/engine/reference/builder/",target:"_blank",rel:"noopener noreferrer"},u={href:"https://docs.docker.com/compose/compose-file/",target:"_blank",rel:"noopener noreferrer"},k={href:"https://docs.docker.com/compose/",target:"_blank",rel:"noopener noreferrer"},v={href:"https://docs.docker.com/",target:"_blank",rel:"noopener noreferrer"},m={href:"https://golang.org/",target:"_blank",rel:"noopener noreferrer"},b={href:"https://hub.docker.com/_/golang",target:"_blank",rel:"noopener noreferrer"},h={href:"https://hub.docker.com/_/alpine",target:"_blank",rel:"noopener noreferrer"};function g(f,_){const s=c("ExternalLinkIcon");return l(),t("div",null,[r,n("ul",null,[n("li",null,[n("a",d,[a("Dockerfile"),e(s)])]),n("li",null,[n("a",u,[a("docker-compose.yml"),e(s)])]),n("li",null,[n("a",k,[a("docker-compose"),e(s)])]),n("li",null,[n("a",v,[a("docker"),e(s)])]),n("li",null,[n("a",m,[a("go"),e(s)])]),n("li",null,[n("a",b,[a("go docker"),e(s)])]),n("li",null,[n("a",h,[a("alpine docker"),e(s)])])])])}const w=i(p,[["render",g],["__file","5. 部署一个go项目.html.vue"]]);export{w as default};
