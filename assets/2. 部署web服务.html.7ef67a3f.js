import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,e}from"./app.60cc74d8.js";const i={},t=e(`<h1 id="_2-部署web服务" tabindex="-1"><a class="header-anchor" href="#_2-部署web服务" aria-hidden="true">#</a> 2. 部署web服务</h1><h2 id="配置" tabindex="-1"><a class="header-anchor" href="#配置" aria-hidden="true">#</a> 配置</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> /usr/local/nginx/conf/nginx.conf
