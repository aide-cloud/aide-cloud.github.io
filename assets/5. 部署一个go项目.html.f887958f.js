import{_ as l}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as t,c as o,b as n,d as a,a as e,e as i,r as c}from"./app.e3201f13.js";const p={},r=i(`<h1 id="_5-部署一个go项目" tabindex="-1"><a class="header-anchor" href="#_5-部署一个go项目" aria-hidden="true">#</a> 5. 部署一个go项目</h1><h2 id="准备一个go项目" tabindex="-1"><a class="header-anchor" href="#准备一个go项目" aria-hidden="true">#</a> 准备一个go项目</h2><ul><li>创建一个<code>go</code>项目</li></ul><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token comment">// main.go</span>
