import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,e as t}from"./app.8a759086.js";const p={},e=t(`<h1 id="_2-流程控制if" tabindex="-1"><a class="header-anchor" href="#_2-流程控制if" aria-hidden="true">#</a> 2. 流程控制if</h1><blockquote><p>可以在 if 表达式之前添加一个执行语句，再根据变量值进行判断</p></blockquote><h2 id="语法" tabindex="-1"><a class="header-anchor" href="#语法" aria-hidden="true">#</a> 语法</h2><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code># 写法一
