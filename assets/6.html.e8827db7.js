import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,e as t}from"./app.827ec9a5.js";const e={},p=t(`<h1 id="_6-fsnotify包" tabindex="-1"><a class="header-anchor" href="#_6-fsnotify包" aria-hidden="true">#</a> 6. fsnotify包</h1><p><a href="github.com/fsnotify/fsnotify">fsnotify包</a></p><p><code>fsnotify</code> 包提供了对文件系统事件的监听，它可以监听文件的创建、删除、重命名、修改等事件。</p><h2 id="用法" tabindex="-1"><a class="header-anchor" href="#用法" aria-hidden="true">#</a> 用法</h2><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
