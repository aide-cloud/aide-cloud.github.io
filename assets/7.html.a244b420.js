import{_ as i}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as u,c as p,a as l,w as a,e as r,b as n,d as s,r as k}from"./app.8e5c99dd.js";const d={},m=r('<h1 id="_7-os包" tabindex="-1"><a class="header-anchor" href="#_7-os包" aria-hidden="true">#</a> 7. os包</h1><h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h2><p><code>os</code> 包提供了一些与操作系统相关的函数和变量。</p><h2 id="基础用法" tabindex="-1"><a class="header-anchor" href="#基础用法" aria-hidden="true">#</a> 基础用法</h2>',4),v=n("div",{class:"language-go line-numbers-mode","data-ext":"go"},[n("pre",{class:"language-go"},[n("code",null,[n("span",{class:"token keyword"},"package"),s(` main
