...
`),n("span",{class:"token punctuation"},"}"),s(`
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"})])],-1),h=o(`<h3 id="实现原理" tabindex="-1"><a class="header-anchor" href="#实现原理" aria-hidden="true">#</a> 实现原理</h3><p><code>sync.Map</code> 的实现原理是分段锁，它将 <code>map</code> 分为多个段，每个段都有一个互斥锁，当对 <code>map</code> 进行读写操作时，只需要对对应的段加锁即可，这样就可以实现并发安全。</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">type</span> Map <span class="token keyword">struct</span> <span class="token punctuation">{</span>
...
`),n("span",{class:"token keyword"},"func"),s(),n("span",{class:"token function"},"main"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),s(),n("span",{class:"token punctuation"},"{"),s(`
	...
	fmt`),n("span",{class:"token punctuation"},"."),n("span",{class:"token function"},"Println"),n("span",{class:"token punctuation"},"("),s("v"),n("span",{class:"token punctuation"},")"),s(`
`),n("span",{class:"token punctuation"},"}"),s(`
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"})])],-1),y=o(`<h3 id="实现原理-1" tabindex="-1"><a class="header-anchor" href="#实现原理-1" aria-hidden="true">#</a> 实现原理</h3><p><code>sync.Pool</code> 的实现原理是 <code>LIFO</code>，它会维护一个 <code>LIFO</code> 的对象池，当我们调用 <code>Put</code> 方法时，会将对象放入对象池中，当我们调用 <code>Get</code> 方法时，会从对象池中取出对象，如果对象池为空，则会返回 <code>nil</code>。</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">type</span> Pool <span class="token keyword">struct</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="总结-1" tabindex="-1"><a class="header-anchor" href="#总结-1" aria-hidden="true">#</a> 总结</h3><p><code>sync.Pool</code> 是 <code>Go</code> 语言中的一个对象池，它可以用来存放临时对象，避免频繁的 <code>GC</code>。</p><h2 id="sync-once" tabindex="-1"><a class="header-anchor" href="#sync-once" aria-hidden="true">#</a> sync.Once</h2><h3 id="介绍-2" tabindex="-1"><a class="header-anchor" href="#介绍-2" aria-hidden="true">#</a> 介绍</h3><p><code>sync.Once</code> 是 <code>Go</code> 语言中的一个单例模式的实现，它可以保证某个函数只执行一次。</p><h3 id="用法-2" tabindex="-1"><a class="header-anchor" href="#用法-2" aria-hidden="true">#</a> 用法</h3>`,9),f=n("div",{class:"language-go line-numbers-mode","data-ext":"go"},[n("pre",{class:"language-go"},[n("code",null,[n("span",{class:"token keyword"},"package"),s(` main
...
`),n("span",{class:"token keyword"},"func"),s(),n("span",{class:"token function"},"main"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),s(),n("span",{class:"token punctuation"},"{"),s(`
  ...
  `),n("span",{class:"token punctuation"},"}"),s(`
`),n("span",{class:"token punctuation"},"}"),s(`
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"})])],-1),w=o(`<h3 id="实现原理-2" tabindex="-1"><a class="header-anchor" href="#实现原理-2" aria-hidden="true">#</a> 实现原理</h3><p><code>sync.Once</code> 的实现原理是 <code>CAS</code>，它会维护一个 <code>uint32</code> 类型的 <code>done</code> 变量，当我们调用 <code>Do</code> 方法时，会将 <code>done</code> 变量设置为 <code>1</code>，如果 <code>done</code> 变量已经为 <code>1</code>，则不会执行函数。</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">type</span> Once <span class="token keyword">struct</span> <span class="token punctuation">{</span>
  m    Mutex
  done <span class="token builtin">uint32</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="总结-2" tabindex="-1"><a class="header-anchor" href="#总结-2" aria-hidden="true">#</a> 总结</h3><p><code>sync.Once</code> 是 <code>Go</code> 语言中的一个单例模式的实现，它可以保证某个函数只执行一次。</p><h2 id="sync-rwmutex" tabindex="-1"><a class="header-anchor" href="#sync-rwmutex" aria-hidden="true">#</a> sync.RWMutex</h2><h3 id="介绍-3" tabindex="-1"><a class="header-anchor" href="#介绍-3" aria-hidden="true">#</a> 介绍</h3><p><code>sync.RWMutex</code> 是 <code>Go</code> 语言中的一个读写锁，它可以保证并发安全的读写。</p><h3 id="用法-3" tabindex="-1"><a class="header-anchor" href="#用法-3" aria-hidden="true">#</a> 用法</h3>`,9),x=n("div",{class:"language-go line-numbers-mode","data-ext":"go"},[n("pre",{class:"language-go"},[n("code",null,[n("span",{class:"token keyword"},"package"),s(` main
...
`),n("span",{class:"token punctuation"},"}"),s(`
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"})])],-1),_=o(`<h3 id="实现原理-3" tabindex="-1"><a class="header-anchor" href="#实现原理-3" aria-hidden="true">#</a> 实现原理</h3><p><code>sync.RWMutex</code> 的实现原理是 <code>CAS</code>，它会维护一个 <code>uint32</code> 类型的 <code>w</code> 变量，当我们调用 <code>Lock</code> 方法时，会将 <code>w</code> 变量设置为 <code>1</code>，如果 <code>w</code> 变量已经为 <code>1</code>，则会阻塞，直到 <code>w</code> 变量为 <code>0</code>。</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">type</span> RWMutex <span class="token keyword">struct</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="总结-3" tabindex="-1"><a class="header-anchor" href="#总结-3" aria-hidden="true">#</a> 总结</h3><p><code>sync.RWMutex</code> 是 <code>Go</code> 语言中的一个读写锁，它可以保证并发安全的读写。</p><h2 id="sync-mutex" tabindex="-1"><a class="header-anchor" href="#sync-mutex" aria-hidden="true">#</a> sync.Mutex</h2><h3 id="介绍-4" tabindex="-1"><a class="header-anchor" href="#介绍-4" aria-hidden="true">#</a> 介绍</h3><p><code>sync.Mutex</code> 是 <code>Go</code> 语言中的一个互斥锁，它可以保证并发安全。</p><h3 id="用法-4" tabindex="-1"><a class="header-anchor" href="#用法-4" aria-hidden="true">#</a> 用法</h3>`,9),P=n("div",{class:"language-go line-numbers-mode","data-ext":"go"},[n("pre",{class:"language-go"},[n("code",null,[n("span",{class:"token keyword"},"package"),s(` main
...
`),n("span",{class:"token punctuation"},"}"),s(`
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"})])],-1),A=n("div",{class:"language-go line-numbers-mode","data-ext":"go"},[n("pre",{class:"language-go"},[n("code",null,[n("span",{class:"token keyword"},"package"),s(` main
...
`),n("span",{class:"token punctuation"},"}"),s(`
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"}),n("div",{class:"line-number"})])],-1),W=o(`<h3 id="实现原理-5" tabindex="-1"><a class="header-anchor" href="#实现原理-5" aria-hidden="true">#</a> 实现原理</h3><p><code>sync.WaitGroup</code> 的实现原理是 <code>CAS</code>，它会维护一个 <code>uint32</code> 类型的 <code>state1</code> 变量，当我们调用 <code>Add</code> 方法时，会将 <code>state1</code> 变量加 <code>1</code>，当我们调用 <code>Done</code> 方法时，会将 <code>state1</code> 变量减 <code>1</code>，当 <code>state1</code> 变量为 <code>0</code> 时，<code>Wait</code> 方法会返回。</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">type</span> WaitGroup <span class="token keyword">struct</span> <span class="token punctuation">{</span>
  noCopy noCopy
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="总结-5" tabindex="-1"><a class="header-anchor" href="#总结-5" aria-hidden="true">#</a> 总结</h3><p><code>sync.WaitGroup</code> 是 <code>Go</code> 语言中的一个等待组，它可以保证并发安全的等待。</p>`,5);function C(L,S){const i=r("Tabs");return p(),d("div",null,[m,l(i,{id:"15",data:[{title:"基本用法",value:"基本用法"},{title:"sync.Map遍历",value:"sync.Map遍历"}],"tab-id":"fruit"},{tab0:a(({title:e,value:t,isActive:c})=>[v]),tab1:a(({title:e,value:t,isActive:c})=>[b]),_:1},8,["data"]),h,l(i,{id:"48",data:[{title:"基本用法",value:"基本用法"}],"tab-id":"fruit"},{tab0:a(({title:e,value:t,isActive:c})=>[g]),_:1}),y,l(i,{id:"78",data:[{title:"基本用法",value:"基本用法"}],"tab-id":"fruit"},{tab0:a(({title:e,value:t,isActive:c})=>[f]),_:1}),w,l(i,{id:"108",data:[{title:"基本用法",value:"基本用法"}],"tab-id":"fruit"},{tab0:a(({title:e,value:t,isActive:c})=>[x]),_:1}),_,l(i,{id:"138",data:[{title:"基本用法",value:"基本用法"}],"tab-id":"fruit"},{tab0:a(({title:e,value:t,isActive:c})=>[P]),_:1}),G,l(i,{id:"168",data:[{title:"基本用法",value:"基本用法"},{title:"多任务",value:"多任务"}],"tab-id":"fruit"},{tab0:a(({title:e,value:t,isActive:c})=>[M]),tab1:a(({title:e,value:t,isActive:c})=>[A]),_:1}),W])}const R=u(k,[["render",C],["__file","1.html.vue"]]);export{R as default};
