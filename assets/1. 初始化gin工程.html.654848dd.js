import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as a,c as s,e}from"./app.563f81e6.js";const i={},t=e(`<h1 id="_1-初始化gin工程" tabindex="-1"><a class="header-anchor" href="#_1-初始化gin工程" aria-hidden="true">#</a> 1. 初始化gin工程</h1><h2 id="初始化mod" tabindex="-1"><a class="header-anchor" href="#初始化mod" aria-hidden="true">#</a> 初始化mod</h2><ul><li>默认已具备go开发环境</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>go mod init <span class="token string">&quot;&lt;your mod name&gt;&quot;</span>
